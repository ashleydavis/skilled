...
Cut a GitHub Release for this repo. Do the work; do not only describe it. Stop and tell the human if any check below fails. Do not invent a version, skip a step, or force-push.
